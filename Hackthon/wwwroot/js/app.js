    ...
    initApp = (function (app) {
        ...
        app.SmartActions = function () {
            ...
            var smartActions = {
                ...
                userLogout: function ($this) {
                    ...
                    $.SmartMessageBox({
                        title:
                        "<i class='fas fa-sign-out-alt txt-color-orangeDark'></i> Sair <span class='txt-color-orangeDark'><strong>" +
                        $("#show-shortcut").text() +
                        "</strong></span> ?",
                        content: $this.data("logout-msg") ||
                        "Feche o browser para garantir segurança. Você deseja sair?",
                        buttons: "[Não][Sim]"
                ...
                resetWidgets: function ($this) {
                    ...
                    $.SmartMessageBox({
                        title: "<i class='fas fa-sync' style='color:green'></i> Limpar personalizações?",
                        content: $this.data("reset-msg") ||
                        "Deseja limpar as configurações locais?",
                        buttons: "[Não][Sim]"
                    },
                        function (ButtonPressed) {
        ...
        app.applyTheme = function () {
            ...
            if (selectedTheme) {
                ...
                $("#" + selectedTheme).prepend("<i class='fas fa-check fa-fw' id='skin-checked'></i>");
            }
...
function setup_widgets_desktop() {
    ...
    if ($.fn.jarvisWidgets && enableJarvisWidgets) {
        ...
        $("#widget-grid").jarvisWidgets({
            ...
            editClass: "fas fa-cog | fas fa-save",
            editSpeed: 200,
            onEdit: function () {
            },
            // color button
            ...
            fullscreenClass: "fas fa-expand | fas fa-compress",
            fullscreenDiff: 3,
            ...
            refreshButton: true,
            refreshButtonClass: "fas fa-sync-alt",
...
function loadURL(url, container) {
    ...
    $.ajax({
        ...
        beforeSend: function () {
            ...
            // place cog
            container.html('<h1 class="ajax-loading-animation"><i class="fas fa-cog fa-spin"></i> Loading...</h1>');
        ...
        error: function (xhr, status, thrownError, error) {
            container.html(
                '<h4 class="ajax-loading-error"><i class="fas fa-exclamation txt-color-orangeDark"></i> Error requesting <span class="txt-color-red">' +
                url +
                "</span>: " +
                xhr.status +
